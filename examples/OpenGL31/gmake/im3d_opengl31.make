...
ifeq ($(config),debug_win32)
  ...
  DEFINES += -DIM3D_DEBUG -DIM3D_OPENGL -DGLEW_STATIC -DIM3D_OPENGL_VMAJ=3 -DIM3D_OPENGL_VMIN=1 -DIM3D_OPENGL_VSHADER=140 -DIM3D_VERTEX_ALIGNEMENT=16
  INCLUDES += -I../../.. -I../../common
  FORCE_INCLUDE +=
...
ifeq ($(config),release_win32)
  ...
  DEFINES += -DIM3D_OPENGL -DGLEW_STATIC -DIM3D_OPENGL_VMAJ=3 -DIM3D_OPENGL_VMIN=1 -DIM3D_OPENGL_VSHADER=140 -DIM3D_VERTEX_ALIGNEMENT=16
  INCLUDES += -I../../.. -I../../common
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
