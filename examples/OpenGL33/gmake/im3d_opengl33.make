...
ifeq ($(config),debug_win32)
  RESCOMP = windres
  TARGETDIR = ..
  TARGET = $(TARGETDIR)/im3d_opengl33_debug.exe
  OBJDIR = obj/Win32/Debug
  DEFINES += -DIM3D_DEBUG -DIM3D_OPENGL -DGLEW_STATIC -DIM3D_OPENGL_VMAJ=3 -DIM3D_OPENGL_VMIN=3 -DIM3D_OPENGL_VSHADER=330
  INCLUDES += -I../../.. -I../../common
  FORCE_INCLUDE +=
...
ifeq ($(config),release_win32)
  RESCOMP = windres
  TARGETDIR = ..
  TARGET = $(TARGETDIR)/im3d_opengl33.exe
  OBJDIR = obj/Win32/Release
  DEFINES += -DIM3D_OPENGL -DGLEW_STATIC -DIM3D_OPENGL_VMAJ=3 -DIM3D_OPENGL_VMIN=3 -DIM3D_OPENGL_VSHADER=330
  INCLUDES += -I../../.. -I../../common
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/im3d.o: ../../../im3d.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/im3d_opengl33.o: ../im3d_opengl33.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
